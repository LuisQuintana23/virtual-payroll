...
--@Descripción: Creación de tablas, indices para el sistema de honorarios de virtual payroll
...
CREATE TABLE empleado_base(
  ...
  numero_empleado_base number(10,0) NOT NULL,
...
CREATE TABLE empleado_beneficiario(
  empleado_beneficiario_id number(10,0) CONSTRAINT empleado_beneficiario PRIMARY KEY,
...
CREATE TABLE empleado_nomina_concepto_pago(
  empleado_nomina_concepto_pago_id number(10,0) CONSTRAINT empleado_nomina_concepto_pago_pk PRIMARY KEY,
